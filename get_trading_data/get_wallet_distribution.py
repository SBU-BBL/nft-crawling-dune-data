...
query_id = config['QUERY_ID'][time]['wallet_distribution_overtime']
...
try:
    ...
    params=[
        QueryParameter.text_type(name="Wallet Distribution Over Time - weekly Contract address:", value=contract_address), 
        QueryParameter.text_type(name="Wallet Distribution Over Time - weekly Dataset", value="erc721_ethereum.evt_Transfer")
    ]
    )
