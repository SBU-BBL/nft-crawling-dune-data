...
query_id = config['QUERY_ID'][time]['unique_buyers_sellers']
...
try:
    ...
    query_id=query_id,
    params=[
        QueryParameter.text_type(name="Unique Buyers and Sellers - weekly Contract address:", value=contract_address), 
        QueryParameter.text_type(name="Unique Buyers and Sellers - weekly Time interval", value=interval)
    ]
    )
