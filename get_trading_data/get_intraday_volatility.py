...
query_id = config['QUERY_ID'][time]['intraday_volatility']
...
try:
    ...
    params=[
        QueryParameter.text_type(name="Intra-Day Volatility - weekly Contract address:", value=contract_address), 
        QueryParameter.text_type(name="Intra-Day - weekly Time interval", value=interval)
    ]
    )
